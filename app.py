...
#VOLATILITY
    ...
    if action == 'printkey':
        #profile = request.form['profile']
        command = ['python2', '/usr/bin/vol.py', '-f', '/home/kali/Downloads/capstone7/Image/memdumpWin7.mem', '--profile='+profile,'hivelist']
        #print(profile)
    ...
    if action == 'netscan':
        #profile = request.form['profile']
        command = ['python2', '/usr/bin/vol.py', '-f', '/home/kali/Downloads/capstone7/Image/memdumpWin7.mem', '--profile='+profile,'netscan']
        #print(profile)
        #result = subprocess.run(command, capture_output=True)
    ...
    if action == 'pslist':
        #profile = request.form['profile']
        command = ['python2', '/usr/bin/vol.py', '-f', '/home/kali/Downloads/capstone7/Image/memdumpWin7.mem', '--profile='+profile,'pslist']
        #print(profile)
        #result = subprocess.run(command, capture_output=True)
    ...
    if action == 'psxview':
        #profile = request.form['profile']
        command = ['python2', '/usr/bin/vol.py', '-f', '/home/kali/Downloads/capstone7/Image/memdumpWin7.mem', '--profile='+profile,'psxview']
        #print(profile)
        #result = subprocess.run(command, capture_output=True)
